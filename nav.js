document.addEventListener('DOMContentLoaded', () => {
    ...
    nav.innerHTML = `
        <div style="position: fixed; bottom: 20px; right: 20px; z-index: 99999; background: #000; border: 2px solid #16A34A; padding: 15px; font-family: 'Inter', sans-serif; box-shadow: 4px 4px 0px #16A34A;">
            ...
            <div style="display: flex; flex-direction: column; gap: 8px;">
                <a href="/" style="color: white; text-decoration: none; font-size: 11px; font-weight: bold; text-transform: uppercase;" onmouseover="this.style.color='#16A34A'" onmouseout="this.style.color='white'">1. Landing</a>
