/**
 * FoodCycle - Definitive Icon Library
 * Consolidated SVG definitions for all platform personas and features.
 */
...
const ICONS = {
    ...
    // Food Specific (Lab Project Icons)
...
const DEFAULT_ICON = '<circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/>';
...
function renderIcons() {
    document.querySelectorAll('[data-icon]').forEach(el => {
        ...
        if (!svgContent) {
            console.warn(`Icon "${name}" not found in local library. Using fallback.`);
