            ...
            <div class="p-6 arch-border-b sticky z-40 flex flex-col gap-4" style="top:0;background:rgba(244,244,240,0.9);backdrop-filter:blur(4px)">
                <div class="flex justify-between items-start sm-items-center" style="flex-wrap:wrap;gap:1rem">
                    <div>
                        ...
                        <p class="font-mono text-xs uppercase" style="color:var(--arch-gray)">Showing <?php echo count($listings); ?> active listings</p>
                    </div>
                    <div class="flex items-center gap-4">
                    ...
                    <?php foreach ($listings as $item): ?>
                        <article class="card-hover flex flex-col relative">
                            ...
                            <div class="catalogue-img img-placeholder" style="background:var(--arch-light)">
                                ...
                                <div class="img-id">ID: BATCH-<?php echo str_pad($item['id'], 4, '0', STR_PAD_LEFT); ?></div>
                            </div>
                            <div class="p-5 flex-1 flex flex-col">
                                <h3 class="font-bold text-xl uppercase leading-tight mb-2"><?php echo htmlspecialchars($item['title']); ?></h3>
                                <p class="font-mono text-xs mb-4" style="color:var(--arch-gray)"><?php echo htmlspecialchars($item['operator_name']); ?> &bull; <?php echo htmlspecialchars($item['pickup_location']); ?></p>
                                <div class="grid grid-cols-2 gap-2 mb-6 font-mono uppercase" style="font-size:0.625rem">
                                    <div class="arch-border p-2" style="background:var(--arch-light)">
                                        ...
                                        <span class="font-bold text-sm">~<?php echo htmlspecialchars($item['quantity']); ?> lbs</span>
                                    </div>
                                    <div class="arch-border p-2" style="background:var(--arch-light)">
                                        <span class="block mb-1" style="color:var(--arch-gray)">Expires AT</span>
                                        <span class="font-bold text-sm"><?php echo date('H:i', strtotime($item['available_until'])); ?></span>
                                    </div>
                                </div>
